...
Now we can also facet the data into the majors which gives us a third dimensions. 
To avoid a convoluted 3D plot we instead use faceting to divide the majors into 2-dimensional plots.

![Plot 2: GPA change over AI usage by majors](docs/eda_files/ai_usage_gpa_change_by_majors.png)

*Discussion*

These plots indicate following trend equally for all majors:  
...
Though the GPA change seems to be positive for all majors in general.  
